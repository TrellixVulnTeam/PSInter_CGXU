    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_Klienta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='warzywniak.klienci')),
                ('id_Warzywa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='warzywniak.warzywa')),
            ],
        ),
    ]
